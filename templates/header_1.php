...
<body>
  ...
  <header role = "header" class = "verticalHeader">
    ...
    <div class ="verticalHeader_info"><!--Contains informatino about app-->
      <p>Created By:<br><br> Wesley Elliot<br>Jeremy Jones<br>Ann Oesterle</p>
                <a href = "logout.php" class ="aboutLink"><p >about</p></a>
                <a rel="license" class = "license" href="http://creativecommons.org/licenses/by/4.0/">This work is licensed under a Creative Commons Attribution 4.0 International License</a>
